...
Table~\ref{tab:fullstack_rank02_top5} summarises the five strongest full-stack model combinations under the rank-02 replay setting. To keep the comparison focused on deployment-relevant trade-offs, the table reports pass-detection accuracy, dominant-team possession agreement, runtime throughput, and GPU usage.
