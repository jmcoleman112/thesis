#!/usr/bin/env python
"""
Temperature scatter plot for the shortlisted object and pose models.

Run:
  python Figures/scatter/best_model_analysis_object_pose_temp.py
"""
...
def main() -> int:
    ...
    plt.show()
    prompt_save_figure(fig, default_name="best_model_analysis_object_pose_temp")
    return 0
